...
> 📎 Imagen de referencia: `image-20240712-131245.png` *(disponible en Confluence)*
...
> 📎 Imágenes de referencia: `image-20240712-131817.png`, `image-20240712-131946.png` *(disponibles en Confluence)*
...
> 📎 Imágenes de referencia: `image-20240712-132911.png`, `image-20240712-133101.png` *(disponibles en Confluence)*  
> *Al finalizar la construcción debe verse como en la imagen de referencia.*

### 5. Configurar el Template de Arranque

Configurar el template de arranque de la aplicación.

> 📎 Imagen de referencia: `image-20240712-133404.png` *(disponible en Confluence)*
...
> 📎 Imagen de referencia: `image-20240715-134300.png` *(disponible en Confluence)*

### 7. Verificar Health Check

Una vez iniciada la aplicación, verificar su funcionamiento mediante el endpoint de health check de la API.

> 📎 Imagen de referencia: `image-20240715-135208.png` *(disponible en Confluence)*
