...
> **Fuente Confluence:** [Estructura Proyecto - PEPSMS](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/1809908172)
> **Espacio:** EPA
> **Última modificación Confluence:** 2021-03-26 | Versión 11
...
![Estructura generada a partir de lego](./attachments/image-20210326-164052.png)

*Figura 1. Estructura generada a partir de lego (legoapp-0.0.19.jar)*
...
![División de proyecto](./attachments/image-20210326-165347.png)

*Figura 2. División de proyecto*

![Estructura proyecto definición dominio](./attachments/image-20210326-171326.png)

*Figura 3. Estructura proyecto definición dominio*

![Estructura proyecto definición casos de uso](./attachments/image-20210326-171439.png)

*Figura 4. Estructura proyecto definición casos de uso*

![Estructura proyecto implementación persistencia de objetos de dominio](./attachments/image-20210326-171542.png)

*Figura 5. Estructura proyecto implementación persistencia de objetos de dominio*

![Estructura proyecto definición de endpoints aplicación](./attachments/image-20210326-171658.png)

*Figura 6. Estructura proyecto definición de endpoints aplicación*

## Configuración base de datos

Se requiere el uso de dos conexiones a base de datos. La configuración se encuentra definida en el archivo ***application.yml*** del proyecto ***applications-app-service***, adicional de contener clases de configuración para cada una de las conexiones.
...
Se consumen servicios SOAP para consultar y registrar información de personas (Información registrada en ***application.yml*** del proyecto ***applications-app-service***, junto con clase de configuración)
