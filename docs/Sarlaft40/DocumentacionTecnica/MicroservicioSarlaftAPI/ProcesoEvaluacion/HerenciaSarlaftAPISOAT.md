# Herencia Sarlat API para el SOAT

> **Fuente Confluence:** [Herencia Sarlat API para el SOAT](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/3917152264)
> **Última modificación:** 2024-07-29 — Brayan Estiven Sepúlveda Quintero · versión 1
...
![Métodos impactados en PrepararEvaluacion.java](./attachments/image-20240729-220023.png)
