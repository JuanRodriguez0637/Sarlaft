...
> **Última modificación:** 2023-08-09 — Julián Andrés Curubo García · versión 7
> **Sección:** [Creación token JWT](../index.md)
...
![image-20230809-200132.png](./attachments/image-20230809-200132.png)

Se parametrizó para el caso del aplicativo SEL (SuraEnLinea) un tiempo de vigencia para el token JWT de 15 minutos:

![image-20230809-200754.png](./attachments/image-20230809-200754.png)
