...
> **Fuente Confluence:** [Configuración Ambiente - SarlaftAPI](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/1801159141)
> **Última modificación:** 2025-12-29 — Diana Muñoz · versión 24
...
![KeyStore Explorer — instalación de certificados](./attachments/image-20240712-131245.png)
...
![Configurar JDK — estructura del proyecto](./attachments/image-20240712-131817.png)

![Configurar JDK — versión del SDK](./attachments/image-20240712-131946.png)
...
![Gradle build — construcción en curso](./attachments/image-20240712-132911.png)

![Gradle build — construcción finalizada correctamente](./attachments/image-20240712-133101.png)

### 5. Configurar el Template de Arranque

Configurar el template de arranque de la aplicación.

![Template de arranque — configuración de ejecución](./attachments/image-20240712-133404.png)
...
![Error de acceso a base de datos — solicitar permiso de IP](./attachments/image-20240715-134300.png)

### 7. Verificar Health Check

Una vez iniciada la aplicación, verificar su funcionamiento mediante el endpoint de health check de la API.

![Health Check — respuesta del endpoint](./attachments/image-20240715-135208.png)
