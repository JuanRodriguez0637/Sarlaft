...
> **Última modificación:** 2024-11-03 — Julián Andrés Curubo García · versión 5
> **Sección:** [Microservicio SarlaftClientesMS](./index.md)

Este nuevo servicio web de healthCheck permite evaluar las conexiones principales del microservicio de tal forma que cuando desde el aks en azure, se haga el ping para evaluar la salud del microservicio se evalúe de igual forma la conexión al service bus de azure y a la base de datos.
...
![image-20240208-174721.png](./attachments/image-20240208-174721.png)

Se realiza la siguiente configuración en el **application.yaml**

![image-20240208-174751.png](./attachments/image-20240208-174751.png)

Se realiza la siguiente configuración en el archivo **deployment.yml** en el proyecto de configuración para cada ambiente.

![image-20240208-174917.png](./attachments/image-20240208-174917.png)
