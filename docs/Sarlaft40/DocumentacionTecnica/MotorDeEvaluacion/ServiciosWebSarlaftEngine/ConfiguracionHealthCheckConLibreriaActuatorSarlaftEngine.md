...
> **Fuente Confluence:** [Configuración HealtchCheck con librería actuator - SarlaftEngine](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/3612016665)
> **Última modificación:** 2024-03-20 — Julián Andrés Curubo García · versión 2
> **Sección:** [Servicios Web - SarlaftEngine](./index.md)

Este nuevo servicio web de healthCheck permite evaluar las conexiones principales del microservicio de tal forma que cuando desde el aks en azure, se haga el ping para evaluar la salud del microservicio, se evalúe de igual forma la conexión al service bus de azure y base de datos Postgresql (nube).
