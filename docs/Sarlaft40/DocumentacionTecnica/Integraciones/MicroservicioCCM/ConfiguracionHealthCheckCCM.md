# Configuración HealtchCheck con librería actuator - CCM

> **Fuente Confluence:** [Configuración HealtchCheck con librería actuator - CCM](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/3617292313/Configuraci%C3%B3n+HealtchCheck+con+librer%C3%ADa+actuator+-+CCM)
> **Última modificación:** 2024-04-04 — Diana Muñoz · versión 3
> **Sección:** [Microservicio - CCM](./index.md)

Este nuevo servicio web de healthCheck permite evaluar las conexiones principales del microservicio de tal forma que cuando desde el aks en azure, se haga el ping para evaluar la salud del microservicio se evalué de igual forma las conexiones a base de datos, rabbitmq y conexión al service bus de azure.
...
![image-20240318-215905.png](./attachments/image-20240318-215905.png)Se realiza la siguiente configuración en el archivo deployment.yml en el proyecto de configuración para cada ambiente.
![image-20240318-215841.png](./attachments/image-20240318-215841.png)
