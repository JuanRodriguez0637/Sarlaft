...
<u>a. Conectarse al AKS por medio</u>
...
![image-20210412-151622.png](./attachments/image-20210412-151622.png)

<u>b. Importar en el local, las credenciales de acceso al AKS para poder usar el comando `kubectl`</u>\
`az aks get-credentials --resource-group rg-sarlaft-lab-001 --name aks-sarlaft`

![image-20210412-151305.png](./attachments/image-20210412-151305.png)

c. Instalar RabbitMQ cluster operator por medio de la instrucción:\
`kubectl apply -f "https://github.com/rabbitmq/cluster-operator/releases/latest/download/cluster-operator.yml"`

![image-20210412-151504.png](./attachments/image-20210412-151504.png)
...
![image-20210412-180626.png](./attachments/image-20210412-180626.png)
