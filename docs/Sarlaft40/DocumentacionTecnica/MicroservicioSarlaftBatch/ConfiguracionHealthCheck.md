# Configuración HealtchCheck con librería actuator - SarlaftBatch

> **Fuente Confluence:** [Configuración HealtchCheck con librería actuator - SarlaftBatch](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/3598614623/Configuraci+n+HealtchCheck+con+librer+a+actuator+-+SarlaftBatch)
> **Última modificación:** 2024-03-20 — Julián Andrés Curubo García · versión 3
> **Sección:** [Mircroservicio sarlaftBatch](./index.md)

Este nuevo servicio web de healthCheck permite evaluar las conexiones principales del microservicio de tal forma que cuando desde el aks en azure, se haga el ping para evaluar la salud del microservicio, se evalúe de igual forma la conexión al service bus de azure, base de datos Postgresql (nube) y redis (nube).
...
![build.gradle con actuator](./attachments/image-20240207-200559.png)
...
![ServicebusHealthIndicator](./attachments/image-20240311-234635.png)

Se realiza la siguiente configuración en el **application.yaml**

![Configuración application.yaml](./attachments/image-20240311-234659.png)

Se realiza la siguiente configuración en el archivo **deployment.yml** en el proyecto de configuración para cada ambiente.

![Configuración deployment.yml](./attachments/image-20240311-234740.png)
...
![Configuración splunk loggers](./attachments/image-20240311-234809.png)
