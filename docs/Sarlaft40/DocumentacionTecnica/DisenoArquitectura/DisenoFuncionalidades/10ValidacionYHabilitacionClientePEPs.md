...
> **Fuente Confluence:** [10. Validación y Habilitación Cliente PEPs](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/3226599489)
...
![Flujo PEPS - Validación y Habilitación](./attachments/Sarlaft_Laura-FlujoPEPS%20%282%29-20230615-212353.jpg)
...
![Campo PEPS en JSON](./attachments/image-20230616-125400.png)
...
![Formulario pregunta PEPS](./attachments/image-20230616-130804.png)

Escenario de marcación cliente peps

![Flujo PEPS - Marcación](./attachments/Sarlaft_Laura-FlujoPEPS_Marcacion%20%281%29-20230616-164358.jpg)
...
![Campo PEPS PJ en JSON](./attachments/image-20230616-131617.png)

Si el campo no llega en la evaluación la pregunta se realiza al momento de diligenciar el formulario, si la respuesta es SI, el sistema recategoriza la evaluación a intensificado y marca la persona como Peps en el modelo Peps de Sura.

![Formulario pregunta PEPS PJ](./attachments/image-20230616-131522.png)
