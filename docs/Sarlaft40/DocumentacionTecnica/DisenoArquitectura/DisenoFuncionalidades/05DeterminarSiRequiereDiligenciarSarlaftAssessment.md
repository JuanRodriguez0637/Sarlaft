...
> **Fuente Confluence:** [5. Determinar si requiere diligenciar Sarlaft (Assessment)](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/3222634497)
...
Esta validación comienza con la consulta de sarlaft vigentes en `PrepararEvaluacion` : `requiereDiligenciarFormulario`, el query esta en la clase `SarlaftData` bajo el nombre "`SarlaftData.findByDniAndVigencia`".
