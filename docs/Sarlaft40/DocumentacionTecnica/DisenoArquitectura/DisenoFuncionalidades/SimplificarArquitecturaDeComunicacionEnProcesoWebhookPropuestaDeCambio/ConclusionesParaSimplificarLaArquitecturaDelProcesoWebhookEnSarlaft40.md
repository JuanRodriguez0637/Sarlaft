...
> **Fuente Confluence:** [Conclusiones para simplificar la arquitectura del proceso webhook en Sarlaft 4.0](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/3743219726)
...
- Se ha decidido implementar la [solución#1](./Propuesta1OmitirLaComunicacionQuePasaPorAzureServiceBus.md), que consiste en eliminar la comunicación a través del Azure Service Bus entre los microservicios `sarlaftapi` y `sarlaftwebhook`, sustituyendo el intercambio de queries y comandos.
