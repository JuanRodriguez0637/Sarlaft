...
> **Última modificación:** 2022-08-25 · versión 3
> **Sección:** [Comunicaciones - Microservicio SarlaftClientes](./index.md)

Esta integración se realiza por medio del Service Bus al escuchar el query **Proceso.actualizacion.autocompletar** que llega de las aplicación _**sarlaftbatch**_. En la integración se recibe el documento que corresponde al cliente que serán consultado en fuentes de información externas(_**WebApp Clientes PJ, WebApp Clientes PN y WebApp Clientes**_) y para el cual se responderá dicha información.
