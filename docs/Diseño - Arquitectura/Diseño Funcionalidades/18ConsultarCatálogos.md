...
> **Fuente Confluence:** [18. Consultar Catálogos](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/3675586561/18.+Consultar+Cat+logos)  
...
| Archivo | Enlace |
|---------|--------|
| `s4comunicacionCatalogos-20240416-200021.jpg` | [s4comunicacionCatalogos-20240416-200021.jpg](./attachments/s4comunicacionCatalogos-20240416-200021.jpg) |

![s4comunicacionCatalogos-20240416-200021.jpg](./attachments/s4comunicacionCatalogos-20240416-200021.jpg)

La consulta de los catálogos del aplicativo se realiza según el tipo de catalogo:

_**Catalogo Interno:  **_son aquellos catálogos que son administrados por sarlaft 4.0 para su uso interno. Estos catálogos se obtienen de las tablas 

tsaf_catalogo y tsaf_parametro. Antes de hacer la consulta a base de datos, estos son consultados en la cache.
...
_**Catalogo Externo: **_son aquellos catálogos que son administrador por el gobierno de accesos y clientes. Estos catálogos se obtienen del servicio web externo consultarParametrosTipoDescripcion de ServiciosWebSic, para esto se utiliza el microintegrador SarlaftListas. 
...
[Servicio Web - Catálogos](/wiki/spaces/EPA/pages/3387031595/Servicio+Web+-+Cat+logos)