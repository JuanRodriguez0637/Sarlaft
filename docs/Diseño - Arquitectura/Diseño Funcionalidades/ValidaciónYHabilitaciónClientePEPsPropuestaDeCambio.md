...
> **Fuente Confluence:** [Validación y Habilitación Cliente PEPs - propuesta de cambio](https://segurosti.atlassian.net/wiki/spaces/EPA/pages/3648421917/Validaci+n+y+Habilitaci+n+Cliente+PEPs+-+propuesta+de+cambio)  
...
| Archivo | Enlace |
| --------- | -------- |
| `image-20240404-183919.png` | [image-20240404-183919.png](./attachments/image-20240404-183919.png) |
| `image-20240404-183857.png` | [image-20240404-183857.png](./attachments/image-20240404-183857.png) |

Diagrama del estado actual de levantamiento de Control PEPS

![image-20240404-183857.png](./attachments/image-20240404-183857.png)
...
_**1.Diseño del nuevo proceso de levantamiento de control PEPS, interacción de componentes, cambio de comunicaciones de mensajería tipo Query a comunicación por servicio rest.**_
...
![image-20240404-183919.png](./attachments/image-20240404-183919.png)
