# HU 1077087 — [Notificación en la reclamación]: Prendido controlado en producción

[Épica 1032289 — [Conocimiento del Cliente]: Contrapartes](https://dev.azure.com/SuraColombia/Gerencia_Tecnologia/_workitems/edit/1032289) › [Feature 1049126 — [Aplicativos de negocio]: Notificar en la reclamación el Formulario con estado pendiente](https://dev.azure.com/SuraColombia/Gerencia_Tecnologia/_workitems/edit/1049126) › HU 1077087 — [Notificación en la reclamación]: Prendido controlado en producción
...
| Campo | Valor |
|-------|-------|
| **ID** | [1077087](https://dev.azure.com/SuraColombia/Gerencia_Tecnologia/_workitems/edit/1077087) |
| **Estado** | New |
...
definir un ejemplo mínimo en pdn para revisar el comportamiento en ambiente productivo
