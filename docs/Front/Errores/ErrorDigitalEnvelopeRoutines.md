...
![image-20230628-175950.png](../img/image-20230628-175950.png)
...
- Eliminar la carpeta local del proyecto para descontaminar el ambiente local

- Desinstalar la versión actual de **Node.js **y de **Angular **de su maquina e instalar la versión [Node.js v16.16.0 (LTS)](https://nodejs.org/en/blog/release/v16.16.0). Instalar Angular** **es opcional ya que al ejecutar `npm install` en el directorio del proyecto se instala automáticamente la versión de Angular compatible.

- Seguir nuevamente los pasos de configuración de ambiente: [Configuración ambiente](../ConfiguracionAmbiente/index.md)
