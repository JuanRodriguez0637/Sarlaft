...
> **Última modificación:** 2022-09-09 · versión 1
...
- Sino se envía un ORDER por defecto se organiza por FECHA_ESTADO

- Sino se envía un TIPO ORDER por defecto se organiza  de manera descendente.
