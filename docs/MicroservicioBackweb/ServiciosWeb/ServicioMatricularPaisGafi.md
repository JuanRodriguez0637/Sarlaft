...
_Código_: Pertenece al código del país, relacionado con los catálogos de países

_Bloqueante_: Indica si el país ingresado es bloqueante o no de acuerdo a lo siguiente:

 Gafi Gris: Bloqueante N sin fecha de baja
 Gafi Negro: Bloqueante S sin fecha de baja
 Sin Categoria: Se asigna fecha de baja, se envia NA en el servicio
