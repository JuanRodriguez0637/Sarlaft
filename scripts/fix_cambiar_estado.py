...
path = r'D:\Sarlaft 4.0\docs\MicroservicioBackweb\ServiciosWeb\ServicioCambiarEstadoEntidad.md'
...
[/wiki/download/attachments/2935160848/request%20(1).json?version=1&modificationDate=1665152834496&cacheVersion=1&api=v2](/wiki/download/attachments/2935160848/request%20(1).json?version=1&modificationDate=1665152834496&cacheVersion=1&api=v2)
...
new = """**Descripción:** Servicio que permite cambiar el estado de una entidad (`tsaf_entidad`).
